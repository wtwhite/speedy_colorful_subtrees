select
	1 - avg(cast(r3.nedges as numeric) / r0.nedges) as worst_r3_red,
	1 - avg(cast(r4.nedges as numeric) / r0.nedges) as worst_r4_red,
	1 - avg(cast(r6.nedges as numeric) / r0.nedges) as worst_r6_red
